...
const sidebarItemsTwo = [
  {
    ...
    icon: <Settings size={18} className="" />
  },
  {
    label: 'Help & Support', 
    href: '/dashboard/support', 
    icon: <HelpCircle size={18} className="" />
  },
];
...
const getSidebarItems = (role: string): SidebarItem[] => {
  ...
  switch (role?.toLowerCase()) {
    case 'host':
      return [
        { label: 'Dashboard', href: '/dashboard', icon: <Home size={18} className="" /> },
        { label: 'My Tours', href: '/dashboard/my-tours', icon: <MapPin size={18} className="" /> },
        { label: 'Custom Tour Request', href: '/dashboard/custom-tour-request', icon: <FileText size={18} className="" /> },
        { label: 'Live Tours', href: '/dashboard/live-tours', icon: <Video size={18} className="" /> },
        { label: 'Reels', href: '/dashboard/reels', icon: <Play size={18} className="" /> },
    ...
    case 'guest':
      return [
        { label: 'Dashboard', href: '/dashboard', icon: <Home size={18} className="" /> },
        { label: 'My Bookings', href: '/dashboard/my-bookings', icon: <Calendar size={18} className="" /> },
        { label: 'Customize Tours', href: '/dashboard/customize-tours', icon: <FileText size={18} className="" /> },
        { label: 'Live Tours', href: '/dashboard/live-tours', icon: <Video size={18} className="" /> },
        { label: 'Reels', href: '/dashboard/reels', icon: <Play size={18} className="" /> },
        { label: 'Saved Tours', href: '/dashboard/saved-tours', icon: <Heart size={18} className="" /> },
        { label: 'Offers', href: '/dashboard/offers', icon: <Gift size={18} className="" /> },
        { label: 'Reviews', href: '/dashboard/reviews', icon: <Star size={18} className="" /> },
        { label: 'Payment', href: '/dashboard/payment', icon: <CreditCard size={18} className="" /> },
      ];
    
    case 'facilitator':
      return [
        { label: 'Dashboard', href: '/dashboard', icon: <Home size={18} className="" /> },
        { label: 'Assigned Tours', href: '/dashboard/assigned-tours', icon: <MapPin size={18} className="" /> },
        { label: 'Custom Tour Invites', href: '/dashboard/custom-tour-invites', icon: <FileText size={18} className="" /> },
        { label: 'Live Tour', href: '/dashboard/live-tour', icon: <Video size={18} className="" /> },
        { label: 'Pre Tour Checklist', href: '/dashboard/pre-tour-checklist', icon: <CheckSquare size={18} className="" /> },
        { label: 'Guest Notes', href: '/dashboard/guest-notes', icon: <Clipboard size={18} className="" /> },
        { label: 'Translator Request', href: '/dashboard/translator-request', icon: <Languages size={18} className="" /> },
        { label: 'Submit Reports', href: '/dashboard/submit-reports', icon: <Send size={18} className="" /> },
        { label: 'Feedback', href: '/dashboard/feedback', icon: <MessageSquare size={18} className="" /> },
        { label: 'Earnings', href: '/dashboard/earnings', icon: <DollarSign size={18} className="" /> },
      ];
    ...
    case 'translator':
      return [
        ...
        { label: 'Assigned Tours', href: '/dashboard/assigned-tours', icon: <MapPin size={18} className="" /> },
        { label: 'Custom Tour Invites', href: '/dashboard/custom-tour-invites', icon: <FileText size={18} className="" /> },
        { label: 'Prep Room', href: '/dashboard/prep-room', icon: <CheckSquare size={18} className="" /> },
        { label: 'Translate Live', href: '/dashboard/translate-live', icon: <Languages size={18} className="" /> },
        { label: 'Post-Tour Feedback', href: '/dashboard/post-tour-feedback', icon: <MessageSquare size={18} className="" /> },
        { label: 'Earnings', href: '/dashboard/earnings', icon: <DollarSign size={18} className="" /> },
      ];
    ...
    case 'admin':
      return [
        { label: 'Dashboard', href: '/dashboard', icon: <Home size={18} className="" /> },
        { label: 'Verification & Approval', href: '/dashboard/verifications', icon: <Shield size={18} className="" /> },
        { label: 'Listing Moderation', href: '/dashboard/listing-moderation', icon: <Layout size={18} className="" /> },
        { label: 'Booking Oversight', href: '/dashboard/booking-oversight', icon: <Calendar size={18} className="" /> },
        { label: 'Support', href: '/dashboard/support', icon: <HelpCircle size={18} className="" /> },
        { label: 'Payment Management', href: '/dashboard/payment-management', icon: <CreditCard size={18} className="" /> },
        { label: 'Content Management', href: '/dashboard/content-management', icon: <Package size={18} className="" /> },
        { label: 'Analytics & Performance', href: '/dashboard/analytics-performance', icon: <BarChart3 size={18} className="" /> },
      ];
    
    default: // guest
      return [
        { label: 'Dashboard', href: '/dashboard', icon: <Home size={18} className="" /> },
        { label: 'My Bookings', href: '/dashboard/bookings', icon: <Calendar size={18} className="" /> },
        { label: 'Customize Tours', href: '/dashboard/customize-tours', icon: <FileText size={18} className="" /> },
        { label: 'Live Tours', href: '/dashboard/live-tours', icon: <Video size={18} className="" /> },
        { label: 'Reels', href: '/dashboard/reels', icon: <Play size={18} className="" /> },
        { label: 'Saved Tours', href: '/dashboard/saved', icon: <Heart size={18} className="" /> },
        { label: 'Offers', href: '/dashboard/offers', icon: <Gift size={18} className="" /> },
        { label: 'Reviews', href: '/dashboard/reviews', icon: <Star size={18} className="" /> },
        { label: 'Payment', href: '/dashboard/payment', icon: <CreditCard size={18} className="" /> },
      ];
            ...
            {sidebarItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={`
                    flex items-center relative gap-1 rounded-lg text-sm font-medium transition-colors  
                    ${isActive
                      ? 'text-primary-color !text-[#F26457] font-semibold'
...
//     case 'host':
//       return [
//         ...baseItems.slice(0, 3), // Dashboard, My Bookings
...
//         ...baseItems.slice(6, 7), // Reviews only (skip Payment)
//         ...baseItems.slice(8), // Settings, Help
//       ];
//     case 'facilitator':
//       return [
