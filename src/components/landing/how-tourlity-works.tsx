  ...
  return (
    <section className="w-full bg-global-9 py-14">
      <div className="w-full  mx-auto ">
        <div className="flex flex-col gap-9 justify-between items-center w-full">
          {/* Section Header */}
          <div className="flex flex-col gap-3 justify-start items-center w-auto px-5">
            <h2 className="text-[32px] sm:text-[37px] lg:text-[42px] font-plus-jakarta font-semibold leading-[40px] sm:leading-[47px] lg:leading-[53px] text-center text-global-1">
              How Tourlity Works
            </h2>
            <p className="text-sm description font-normal leading-[17px] text-center text-global-2">
              The easiest way to book local experiences.
            </p>
          </div>

          {/* Steps */}
          <div className="flex flex-col lg:flex-row gap-7 justify-between w-full">
            {[
              {
              ...
              <div
                key={index}
                className="flex flex-col justify-start items-center w-full box-color rounded-[18px] p-7 sm:p-9"
              >
                <div className="flex flex-col justify-start items-center w-full gap-4 mt-9">
                  ...
                  <div className="flex flex-col justify-start items-center w-full">
                    <div className="flex justify-center items-center w-full max-w-[244px] relative">
                      <div className="flex flex-col justify-center items-end w-full">
                        <Image
                          ...
                          width={216}
                          height={254}
                          className="w-full max-w-[220px] h-auto ml-3.5"
                        />
                      </div>
                      <button className="absolute bottom-2 right-0 w-10 h-10 bg-[#f26457] z-40 rounded-[20px] p-3 -ml-7.5 mb-2">
                        <Image
                          src={step.icon}
                          alt="Step icon"
                          width={16}
                    ...
                    <Image
                      ...
                      width={312}
                      height={72}
                      className="w-full ml-3 max-w-[312px] relative z-20 h-auto -mt-12"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-2.5 justify-start items-center w-full px-2">
                    <div className="flex flex-col gap-1 justify-center items-center w-full ">
                      ...
                      <p className="text-sm  description font-inter secondary-text-color font-normal leading-[22px] text-center text-global-2 w-full lg:max-w-3xs">
                        {step.description}
                      </p>
                    </div>
