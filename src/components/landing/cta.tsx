...
function CTA() {
  return (
   <section className="w-full bg-[#1e4d4d] py-[90px] px-4 sm:px-6 lg:px-14">
          <div className="flex flex-col gap-5.5 justify-start items-center w-full max-w-[50%] mx-auto px-6.5">
            <div className="flex items-center gap-2.5 justify-center w-auto">
              <Image
            ...
            <div className="flex items-center gap-2 justify-center w-auto">
              <Button className="bg-[#f26457] text-[#f5f5f4] border border-[#ca3f33] rounded-[14px] px-4 py-2.5 shadow-[0px_7px_25px_#3e3e3e19]">
                Start Exploring Experiences
              </Button>
              <Button className="bg-white text-[#a0a0a0] border border-[#e0e0e0b2] rounded-[14px] px-4 py-2.5">
                See What&apos;s Inside
              </Button>
            </div>
          </div>
