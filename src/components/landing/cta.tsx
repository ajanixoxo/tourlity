...
function CTA() {
  return (
 <section className="bg-[#1e4d4d] py-[90px] -mx-4 lg:-mx-14">
  <div className="flex flex-col gap-5.5 justify-start items-center w-full lg:max-w-[50%] mx-auto px-6.5">
    ...
    <div className="flex items-center flex-col  lg:flex-row gap-2 justify-center w-full">
      <Button variant='primary' className='!font-normal !text-[14px]'>
