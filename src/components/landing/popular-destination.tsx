        ...
        <div className="flex flex-col gap-9 justify-start items-center w-full">
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-3 lg:items-center w-full">
            <div className="flex flex-col gap-3 justify-start items-start w-full">
              <h2 className="text-[28px]  lg:text-[42px] font-plus-jakarta font-bold leading-[40px] sm:leading-[47px] lg:leading-[53px] text-left text-global-1">
            ...
            <Button variant='secondary'
              className='w-max gap-2 lg:w-[150px] flex justify-between items-center text-sm rounded-[14px] py-2.5'>
              View More
