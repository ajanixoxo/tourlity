...
import { Plane, FileText, Languages, CheckSquare, MessageSquare, Calendar, ArrowRight } from "lucide-react"
    ...
    return (
      <Card>
        ...
        <CardContent className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-gray-500 text-center">You have no quick action yet.</p>
        </CardContent>
      </Card>
    )
  }
