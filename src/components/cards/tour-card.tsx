...
function TourCard({ tour }: TourProps) {
    return (
        // lg:overflow-x-auto " style={{scrollbarWidth:"none"}}

        <div key={tour.id} className="flex flex-col box-color justify-start items-center w-[350px] lg:w-[500px] bg-global-8 rounded-[18px] flex-shrink-0">
            <div className="flex flex-col gap-6 justify-start items-center w-full mb-6.5">
                ...
                <div className="flex flex-col gap-3.5 justify-start items-center w-full px-6">
                    <div className="flex flex-col gap-2.5 justify-start items-start w-full">
                        ...
                        <div className="flex justify-start items-center w-full">
                            ...
                            <div className="flex justify-end items-center gap-1">
                                ...
                                <span className="text-xs w-max font-inter font-light text-[14px] leading-[15px] description text-global-2 ml-2">
                    ...
                    <div className="flex justify-center items-center w-full">
                        ...
                        <Button
                            variant={`${tour.isLive ? "primary" : "secondary"}`}
                            className=' text-[#F5F5F4] text-[14px] py-3 lg:py-2 w-[200px] lg:w-[150px] rounded-[14px]'
                        >
                            Book Now
                        </Button>
                    </div>
